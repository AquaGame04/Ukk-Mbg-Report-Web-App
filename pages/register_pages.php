...
<body>
    <div class="login-container">
        ...
        <form action="../auth/register_process.php" method="POST">
            <input type="text" name="uid" placeholder="Buat UID (Contoh: USR001)" reuqired>
            <input type="text" name="nama" placeholder="Nama Lengkap" reuqired>
            <select name="role">
                <option value="Admin">Admin</option>
                <option value="Petugas Gizi">Petugas Gizi</option>
                <option value="Petugas Pengaduan">Petugas Pengaduan</option>
            </select>
            <input type="password" name="password" placeholder="buat Password" reuqired>
